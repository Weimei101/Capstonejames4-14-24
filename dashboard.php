<?php
   ...
   $count_display = mysqli_num_rows($count);
    ...
    $num_nucavailable = mysqli_num_rows($countNucAvailable_query);
     ...
     ///////////////////////////////////* Count PROJECTOR*////////////////////////////
    $count_projector_query = mysqli_query($conn,  "SELECT * FROM `inventory_records` WHERE devicename = 'PROJECTOR'");
    $num_projector = mysqli_num_rows($count_projector_query);
    /* Count PROJECTOR Available*/
    $countProjectorAvailable_query = mysqli_query($conn,  "SELECT * FROM `inventory_records` WHERE devicename = 'PROJECTOR' AND status ='AVAILABLE'");
    $num_projectoravailable = mysqli_num_rows($countProjectorAvailable_query);
     /* Count PROJECTOR Available*/
     $countProjectorUsed_query = mysqli_query($conn,  "SELECT * FROM `inventory_records` WHERE devicename = 'PROJECTOR' AND status ='USED'");
     $num_projectorUsed = mysqli_num_rows($countProjectorUsed_query);
      /* Count PROJECTOR DAMAGE*/
      $countProjectordamage_query = mysqli_query($conn,  "SELECT * FROM `inventory_records` WHERE devicename = 'PROJECTOR' AND status ='DAMAGE'");
      $num_projectordamage = mysqli_num_rows($countProjectordamage_query);
      /* Count PROJECTOR DAMAGE*/
      $countProjectordisposal_query = mysqli_query($conn,  "SELECT * FROM `inventory_records` WHERE devicename = 'PROJECTOR' AND status ='DISPOSAL'");
                                ...
                                <div class="row ml-2">
                                    ...
                                    <div class="col-lg-6 mb-4">
                                        ...
                                        <div class="card bg-info text-white shadow">
                                            <div class="card-body fs-4">
                                                Projector  &nbsp;  <?php  echo $num_projector;
                                             ?>
                                                <div class="text-white-100 small">
                                                <h6>Available: &nbsp;
